...
<div class="div_tong">
	...
	<div class="div_menu">
		...
		<ul class="ul_first">
			<li>
				<a class="the_a" href="../index.php?module=products&action=products_trousers"><span class="span_list" style="line-height: 55px;">Trang Chủ</span></a>
			</li>
			
	      <li>
        	<a class="the_a" href="#"><span class="span_list" style="line-height: 55px;">Quần </span>  <i class="fas fa-caret-down"></i></a>
        <ul>
          <li>
